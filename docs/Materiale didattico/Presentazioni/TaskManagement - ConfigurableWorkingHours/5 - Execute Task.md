...
## Requirements
- manage resource daily working hours by adding a `DailyWorkingHours` column to `Resource` table (decimal, not nullable, default 8.0, range from 0.0 to 24.0). This will represent the default value per resource
