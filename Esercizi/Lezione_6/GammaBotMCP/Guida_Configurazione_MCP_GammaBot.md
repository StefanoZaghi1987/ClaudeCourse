...
|---|---|
| `gammabot-test-taric` | `http://mcp-server-01.internal/mcp/` |
| `gammabot-test-manualisapb1` | `http://mcp-server-02.internal/doc_indexer_mcp/sap_manuali/` |
...
- ✅ **Accesso alla rete aziendale** (i server sono su indirizzi interni `.internal`)
...
```json
{
  "mcpServers": {
    "gammabot-test-taric": {
      "command": "mcp-remote",
      "args": [
        "http://mcp-server-01.internal/mcp/",
        "--allow-http"
      ]
    },
    "gammabot-test-manualisapb1": {
      "command": "mcp-remote",
      "args": [
        "http://mcp-server-02.internal/doc_indexer_mcp/sap_manuali/",
        "--allow-http"
      ]
    }
  },
...
**Causa:** Il PC non riesce a raggiungere i server `mcp-server-01` o `mcp-server-02`.

**Soluzioni:**
- Verificare di essere connessi alla **rete aziendale** (o VPN)
- Testare la raggiungibilità dal terminale:
  ```bash
  ping mcp-server-01.internal
  ```
