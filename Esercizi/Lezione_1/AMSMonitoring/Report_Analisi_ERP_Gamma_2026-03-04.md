...
**Server analizzato:** `erp-server-01` (IP: 192.0.2.10)  
...
L'analisi del report copre il periodo **dal 2 febbraio al 4 marzo 2026** e riguarda il server `erp-server-01`, macchina virtuale VMware su cui è ospitata l'intera piattaforma ERP di Gamma S.p.A. (SAP Business One 10.00.240 su SAP HANA).
...
| TRACE | `/usr/sap/NDB/HDB00/erp-server-01/` | 596,71 GB | 482,27 GB | **80,82%** |
...
| Shared Folder | `\\erp-server-01\B1_SHF` | |
