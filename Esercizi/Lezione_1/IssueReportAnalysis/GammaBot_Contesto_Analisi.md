...
Email: `stefano.zaghi@example.com`
...
L'architettura prevede un **frontend web** (HTML/JS), un **backend API REST** (esposto su `http://gammabot-server-01:3000/`), e un **server di documenti** separato (esposto su `http://192.0.2.49:5000/`). Il sistema supporta modelli AI multipli, tra cui **Claude 3 Opus** (Anthropic) e modelli locali.
